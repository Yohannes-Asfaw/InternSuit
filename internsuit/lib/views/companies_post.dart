                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Column(children: [
                                ...
                                Text(
                                  "@${postList.elementAt(index).company.companywebsite}",
                                  style: const TextStyle(
                                    fontSize: 20,
                                  ),
                                ),
                          ...
                          Column(children: [
                            Container(
                                ...
                                child: Text(
                                  " A  ${postList.elementAt(index).company.dedicatedfield} Company",
                                  style: const TextStyle(
                                    fontSize: 20,
                                  ),
                                )),
                            Container(
                              ...
                              child: Text(
                                "Info :  ${postList.elementAt(index).subject}",
                                style: const TextStyle(
                            ...
                            Container(
                              ...
                              alignment: Alignment.centerLeft,
                              child: Text(
                                "  ${postList.elementAt(index).description}",
                                style: const TextStyle(
                            ...
                            Container(
                                ...
                                alignment: Alignment.centerLeft,
                                child: Text(
                                    " If you need Our Address  @${postList.elementAt(index).company.address}",
                                    style: const TextStyle(
                                      fontSize: 19,
                                    ))),
                          ]),
